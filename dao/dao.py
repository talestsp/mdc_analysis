...
class DAO:
    ...
    def places_df(self, userids=[], columns=["userid", "placeid", "place_label", "with_family", "with_close_friends", "with_friends", "with_colleagues_acquantances", "with_indicental"]):
